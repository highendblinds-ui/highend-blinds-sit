...
function highend_seo_data() {
	return array(
		...
		'curtains'           => array( 'Dream Curtains Edmonton | HighEnd Blinds', 'Light-filtering Dream Curtains with privacy, custom made and professionally installed for Edmonton homes, patio doors, and open-to-above rooms. Motorized operation included.' ),
		...
		'motorized-curtains' => array( 'Motorized Dream Curtains Edmonton | HighEnd Blinds', 'Light-filtering motorized Dream Curtains with privacy for Edmonton homes, including patio doors, open-to-above family rooms, and normal-height windows.' ),
		...
		'edmonton'           => array( 'Custom Blinds Edmonton | Measurement & Installation', 'Custom blinds in Edmonton, locally manufactured and professionally installed. Explore zebra, roller, blackout, sunscreen, Dream Curtain, and motorized options.' ),
		'sherwood-park'      => array( 'Custom Blinds Sherwood Park | HighEnd Blinds', 'Custom blinds in Sherwood Park with free in-home consultation, precise measurement, local manufacturing, and professional installation.' ),
		'st-albert'          => array( 'Custom Blinds St. Albert | HighEnd Blinds', 'Custom blinds and motorized window coverings in St. Albert, made locally with free measurement and professional installation.' ),
		'beaumont'           => array( 'Custom Blinds Beaumont | HighEnd Blinds', 'Made-to-measure blinds and motorized window coverings for Beaumont homes, with local manufacturing and professional installation.' ),
		'leduc'              => array( 'Custom Blinds Leduc | HighEnd Blinds', 'Custom zebra, roller, blackout, sunscreen, and motorized blinds in Leduc with free consultation and professional installation.' ),
		'spruce-grove'       => array( 'Custom Blinds Spruce Grove | HighEnd Blinds', 'Custom blinds in Spruce Grove with in-home fabric guidance, exact measurement, Edmonton manufacturing, and professional installation.' ),
		'fort-saskatchewan'  => array( 'Custom Blinds Fort Saskatchewan | HighEnd Blinds', 'Residential and commercial custom blinds in Fort Saskatchewan with local manufacturing, free measurement, and professional installation.' ),
